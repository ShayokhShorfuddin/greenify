  ...
  return (
    <section>
      <div className="flex flex-col items-center mt-[4rem] xs:mt-[5rem] font-sans">
        <h1 className="text-3xl sm:text-5xl md:text-6xl max-w-4xl text-center leading-[1.15] px-5">
        ...
        <p className="text-sm mt-5 sm:mt-7 text-neutral-700 text-center xs:text-base max-w-xl px-5">
          Build a web that's as clean as it is fast. Get comprehensive carbon
          footprint analysis and reports for your websites, free forever. 🌿
        </p>
      </div>
    </section>
  );
